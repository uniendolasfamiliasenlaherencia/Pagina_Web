  ...
  const especialidades = [
    {
      ...
      youtubeIds: ["9XWlzt7IoYY", "xBj9qGnK2F4"],
    ...
    },
    {
      ...
      youtubeIds: ["9nf-7ArciNk", "0XKWZA4i-mw"],
    ...
    },
    {
      ...
      youtubeIds: ["4SD8pxB7k9w", "D1yTmFU2P4M", "_JJDiOBSLfw", "K_Xqt9MOVaA"],
      youtubeTypes: ["short", "short", "video", "short"],
      videoLayout: "auto"
    },
    {
      ...
      youtubeIds: ["Jz-5N70LdF8", "SCOVFcLx68U"],
      youtubeTypes: ["short", "short"],
      videoLayout: "auto"
    }
  ];
      ...
      <div ref={refCards} className={`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 ${inViewCards ? 'animate-zoom-in' : 'opacity-0'}`}>
        {especialidades.map((especialidad) => (
          <Content_Card
            ...
            youtubeIds={especialidad.youtubeIds}
            youtubeTypes={especialidad.youtubeTypes}
            videoLayout={especialidad.videoLayout}
          />
        ))}
      </div>
    </div>
