...
export default function Footer() {
  return (
    <footer className="w-full text-white py-12" style={{ backgroundColor: '#304B52' }}>
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
          ...
          {/* Centro - Email y Teléfono */}
          <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-8">
            <a
              href="mailto:uniendolasfamiliasenlaherencia@gmail.com"
              className="hover:text-gray-200 transition"
            >
              uniendolasfamiliasenlaherencia@gmail.com
            </a>
            <a
              href="tel:+573142999366"
          ...
          <div className="flex justify-center md:justify-end gap-6">
            {/* Facebook */}
            <a
              href="https://www.facebook.com/MonroyAbogadosCol?locale=es_LA"
              target="_blank"
            ...
            {/* Instagram */}
            <a
              href="https://www.instagram.com/monroyabogados.co"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-gray-200 transition"
              title="Instagram"
